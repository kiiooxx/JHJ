...
param.col_title : ${param.col_title }
param.col_content : ${param.col_content }
<input type="hidden" name="col_title" id="col_title" >
<input type="hidden" name="col_content" id="col_content" >

<table>
	<tr>
		<th>메일 제목</th>
		<td><input type="text" name="title" id="title" size="100" readonly value="${mailOption.title }"/></td>
	</tr>
	<tr>
		<th>메일 내용</th>
		<td>
