					...
					<div id="pageList">
						...
						<c:forEach var="a" begin="${pageInfo.startPage }" end="${pageInfo.endPage }" step="1">
							<c:choose>
								...
								<c:otherwise>
									<a href="productListManagement.ad?search_type=${search_type }&search_text=${search_text }&cate_type=${cate_type }&ca_ref=${ca_ref }&pro_date=${pro_date }&active=${active }&page=${a}">[${a}]</a>
								</c:otherwise>
							</c:choose>
						</c:forEach>
