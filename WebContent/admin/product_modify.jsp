                ...
                <div class="card-body">
	                <table class="table table-bordered">
						<tr>
							...
							<td><input type="text" name="pro_name" id="pro_name" value="${prd.pro_name }" required/>(<span id="pro_name_lengthCheck">0</span>/100)</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><textarea name="pro_detail" id="pro_detail">${prd.pro_detail }</textarea>(<span id="pro_detail_lengthCheck">0</span>/500)</td>
						</tr>
						<tr>
