...
<div id="join_form">
	...
	<form action="boardReRegistAction.bo" method="post" name="f" enctype="multipart/form-data">
		...
		<div class="join_table">
			...
			<table>
				<tr>
					<th>SUBJECT</th>
					<td><input type="text" name="board_re_title" id="board_re_title" style="width:60%">(<span id="lengthCheck">0</span>/100)</td>
				</tr>
				<tr class="editor">
					<th colspan="2" style="padding:0px;">
						<textarea name="board_re_content" id="summernote" style="width:100%; height:200px;"></textarea>
					</th>
				</tr>
			</table>
			<div class="jo_btn">
